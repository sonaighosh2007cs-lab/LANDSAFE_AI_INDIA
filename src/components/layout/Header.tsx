        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-0.5 hidden sm:block font-mono tracking-wide">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative" ref={profileDropdownRef}>
            ...
            {isProfileDropdownOpen && (
              <div className="absolute right-0 mt-2 w-60 rounded-xl bg-[#121214] border border-white/10 shadow-2xl p-2 z-50 animate-in fade-in slide-in-from-top-2">
                <div className="px-3 py-2 border-b border-white/5 mb-1">
                  <p className="text-xs font-semibold text-white truncate">{userProfile.name}</p>
                  <p className="text-[11px] text-gray-400 truncate">{userProfile.email || userProfile.mobile || 'Registered User'}</p>
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-xs text-gray-300 hover:text-white hover:bg-white/5 flex items-center gap-2 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-xs text-red-400 hover:text-red-300 hover:bg-red-500/10 flex items-center gap-2 cursor-pointer"
                >
